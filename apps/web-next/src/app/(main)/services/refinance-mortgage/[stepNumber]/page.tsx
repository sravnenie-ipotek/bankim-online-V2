      ...
      <div className="flex flex-col gap-8 w-full my-8 max-w-[700px] mx-auto">
        ...
        <div className="p-8 bg-base-secondary rounded-lg">
          <h2 className="text-xl font-semibold text-textTheme-primary mb-6">
            {t(`mortgage_refinance_step_${step}`)}
          </h2>

          <div className="flex flex-col gap-4 mb-8">
            {step === 1 && (
              <>
                <label className="text-sm text-textTheme-secondary">{t('mortgage_refinance_price')}</label>
                <div className="h-12 bg-base-inputs rounded-lg" />
                <label className="text-sm text-textTheme-secondary">{t('mortgage_refinance_bank')}</label>
                <div className="h-12 bg-base-inputs rounded-lg" />
                <label className="text-sm text-textTheme-secondary">{t('mortgage_refinance_type')}</label>
                <div className="h-12 bg-base-inputs rounded-lg" />
                <label className="text-sm text-textTheme-secondary">{t('mortgage_refinance_registered')}</label>
                <div className="h-12 bg-base-inputs rounded-lg" />
                <label className="text-sm text-textTheme-secondary">{t('mortgage_refinance_why')}</label>
                <div className="h-12 bg-base-inputs rounded-lg" />
              </>
            )}
            {step === 2 && (
              <>
                ...
                <div className="h-12 bg-base-inputs rounded-lg" />
                <label className="text-sm text-textTheme-secondary">{t('refinance_step2_education')}</label>
                <div className="h-12 bg-base-inputs rounded-lg" />
              </>
            )}
            {step === 3 && (
            ...
            {step === 4 && (
              <>
                <p className="text-textTheme-secondary">{t('refinance_mortgage_warning')}</p>
                <div className="h-12 bg-base-inputs rounded-lg" />
                <div className="h-12 bg-base-inputs rounded-lg" />
              </>
            )}
