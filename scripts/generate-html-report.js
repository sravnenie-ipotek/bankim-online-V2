...
function collectScreenshots() {
  const screenshotDirs = [
    path.join(__dirname, '../apps/web/cypress/screenshots'),
...
function calculateTestMetrics() {
  ...
  const possibleResultPaths = [
    path.join(__dirname, '../apps/web/cypress/results/results.json'),
    path.join(__dirname, '../apps/web/mochawesome-report/mochawesome.json'),
